  ...
  return (
    <nav className='flex w-full justify-between'>
      ...
      <ul className='flex gap-1 sm:gap-2 text-sm sm:text-md '>
         <li className='self-center cursor-pointer text-xs sm:text-lg lg:text-2xl '><a href="#">Menu</a></li>
         <li className='self-center cursor-pointer text-xs sm:text-lg lg:text-2xl'><a href="#">Events</a></li>
         <li className='self-center cursor-pointer text-xs sm:text-lg lg:text-2xl'><a href="#">Gallery</a></li>
         <li className='self-center cursor-pointer text-xs sm:text-lg lg:text-2xl'><a href="#">About</a></li>
         <li className='self-center cursor-pointer text-xs sm:text-lg lg:text-2xl'><a href="#">Contact</a></li>
      </ul>
